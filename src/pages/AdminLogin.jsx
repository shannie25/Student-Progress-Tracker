...
const AdminLogin = () => {
  ...
  return (
    <>
      <Header title="Admin Login - Performance Tracker" />
...
const styles = {
  ...
  button: { padding: '14px', borderRadius: '12px', border: 'none', background: '#dc2626', color: 'white', fontWeight: 'bold', cursor: 'pointer', marginTop: '10px' },
