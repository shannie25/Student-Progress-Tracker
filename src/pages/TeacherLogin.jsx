...
const TeacherLogin = () => {
  ...
  return (
    <>
      <Header title="Teacher Login - Performance Tracker" />
...
const styles = {
  ...
  button: { padding: '14px', borderRadius: '12px', border: 'none', background: '#16a34a', color: 'white', fontWeight: 'bold', cursor: 'pointer', marginTop: '10px' },
